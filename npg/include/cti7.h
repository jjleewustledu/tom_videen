/*  $Log: cti7.h,v $
 * Revision 2.1  2008/01/14  17:09:58  tom
 * increase uncor_singles in Scan3D_subheader7 to 192
 *
 * Revision 2.0  2004/02/12  20:30:50  tom
 * sync Feb 2004
 *
 * Revision 1.8  2004/02/12  20:29:17  tom
 * sync Feb 2004
 *
 * Revision 1.7  2002/11/27  18:24:19  tom
 * *** empty log message ***
 *
 * Revision 1.6  2000/01/20  21:21:55  tom
 * add Attn_subheader7
 *
 * Revision 1.5  1998/12/15  14:33:17  tom
 * revised Scan3D_subheader7 to correspond to CTI documentation
 *
 * Revision 1.4  1998/12/10  18:42:52  tom
 * *** empty log message ***
 *
 * Revision 1.3  1998/01/30  14:20:13  tom
 * add comments
 *
 ...
 * Initial revision
 *
    $Id: cti7.h,v 2.1 2008/01/14 17:09:58 tom Exp tom $
 */
/* =============================================================================
 *  Module:         cti7.h
 *  Date:           Nov 1995
...
/*@unused@*/
#ifndef	lint
static char     cti7_rcsid[] = "$Header: /usr/local/npg/include/RCS/cti7.h,v 2.1 2008/01/14 17:09:58 tom Exp tom $";
#endif
...
#define NUMREC_ASHDR	1		/* Length of an attenuation subheader in records.	*/
#define LEN_MAINHEADER7	256
#define LEN_SSHDR		(LENREC_S*NUMREC_SSHDR)
#define LEN_ISHDR		(LENREC_S*NUMREC_ISHDR)
#define LEN_ASHDR		(LENREC_S*NUMREC_ASHDR)
...
typedef struct X3DSCAN_SUB {
	...
	int frame_start_time;
	int frame_duration;
	float deadtime_correction_fctr;
	short reserved_cti[90];
	short reserved_user[50];
	float uncor_singles[192];
	void *whole_header;
} Scan3D_subheader7;
...
typedef struct XIMAGE_SUB {
	...
	short image_min;
	short image_max;
	float x_pixel_size;		/* cm */
	float y_pixel_size;		/* cm */
	float z_pixel_size;		/* cm */
	int frame_duration;
	int frame_start_time;
	short filter_code;
	float x_resolution;
