 ...
 *		The entire tensor is masked (differs from masktensor)
 *		Total pixels in the mask are returned in npixels.
 *	History:
 *		Revision of masktensor.c
 *
 *  =============================================================================
 */
#ifndef lint
static char     rcsid[] = "$Header: /home/npggw/tom/src/libnrimg/Pre3.0version/RCS/maskalltensor.c,v 1.1 1996/05/23 18:34:32 tom Exp $";
#endif
...
void            maskalltensor (file, img, mskpct, firstpln, lastpln, peakpln, npixels)
	ImageFile      *file;
