...
int	matnum;
{
	...
	{
		case Sinogram : default :
			mat_write_scan_subheader(mptr->fptr, mptr->mhptr, matdir.strtblk, data->shptr);
			break ;
		case PetVolume :
			mat_write_image_subheader(mptr->fptr,mptr->mhptr, matdir.strtblk,data->shptr);
			break ;
		case AttenCor :
			mat_write_attn_subheader(mptr->fptr, mptr->mhptr, matdir.strtblk, data->shptr);
			break ;
		case Normalization :
			mat_write_norm_subheader(mptr->fptr, mptr->mhptr, matdir.strtblk, data->shptr);
			break ;
	}
