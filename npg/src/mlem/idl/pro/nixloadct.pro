...
;    These 4 lines have been added to obtain correct stretching in the case
;    of multiple lookup tables. J Nuyts, 16-nov-1996
;    =====
	    else begin
	      too_high = where(s ge nc, n)
...
PRO NIXLoadct, PICK_ONE=PICK_ONE, SILENT=silent_f, GROUP = GROUP, FILE=file, $
