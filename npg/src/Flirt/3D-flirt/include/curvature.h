//	File curvature.h
//	Low-level routiones for curvature registration based on FFTW
//	General plan for curvature solver.
...
// Prints a deltaPlan to stdout
void printDeltaPlan(deltaPlan p);

//	Creates and initializes the delta for 2 dimensonal transforms
//	@param m1 First dimensions of an 2d linear array stored in column-major-order.
//	@param m2 second dimensions of an 2d linear array stored in column-major-order.
//	@param tau timestep parameter for solving.
//	@param alpha regularizaion  parameter
//
//	Column-major order means the elements of a m1-by-m2 array A with
//		m1 columns and m2 rows are accessed by A(i,j) = A[i+m1*j]
...
//	@param m1 First dimensions of an 3d linear array stored in column-major-order.
//	@param m2 second dimensions of an 2d linear array stored in column-major-order.
//	@param m3 second dimensions of an 2d linear array stored in column-major-order.
//	@param tau timestep parameter for solving.
//	@param alpha regularizaion  parameter
//
//	Column-major order means the elements of a m1-by-m2-by-m3 array A with 
//		m1 columns and m2 rows and m3 slices are accessed by A(i,j,k) = A[i+m1*(j+m2*k)]
