...
int             mat_list (fptr, mlist, lmax)
	...
	int             lmax;
{
	int             blk, num_entry, num_stored, i, stat;
	int             nxtblk, matnum, strtblk, endblk, matstat;
