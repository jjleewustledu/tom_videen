/*$Id: c3101.c,v 1.1 1995/10/16 17:29:59 ty7777 Exp $*/
/*$Log: c3101.c,v $
 * Revision 1.1  1995/10/16  17:29:59  ty7777
 * Initial revision
 **/
...
static char rcsid [] = "$Header: /export/home/npggw/tom/src/libecat7/RCS/c3101.c,v 1.1 1995/10/16 17:29:59 ty7777 Exp $";
...
int             blk_inp_byte_cnt = 0;
int             blk_out_byte_cnt = 0;
int             nac = 0;
int             reset_flag = 0;
int             thresh_in_cnt = 0;
int             comp_diff = 64;
int             period_mask;
int             period = 512;             /*  default period  */
