C$Id: getimg.f,v 1.1 1995/10/09 17:11:18 ty7777 Exp $
C$Log: getimg.f,v $
c Revision 1.1  1995/10/09  17:11:18  ty7777
c Initial revision
c
c
C
...
C
      rcsheader = '$Header: /home/npggw/tom/src/libpetf77/RCS/getimg.f,v 1.1 1995/10/09 17:11:18 ty7777 Exp $'
C
      ERR = .FALSE.
      OPEN (DISK, FILE = FNAME, STATUS = 'OLD', ERR = 120)
      GO TO 150
120   WRITE (*, *) '*** Cannot Open ', FNAME, 'for getimage_type ()'
      RETURN
