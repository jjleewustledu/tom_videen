/*$Id: savesxr.c,v 1.10 1996/04/03 18:05:56 ty7777 Exp $*/
/*$Log: savesxr.c,v $
 * Revision 1.10  1996/04/03  18:05:56  ty7777
 * Updated to add dimensions; to the incorrect_delta_z data.
 *
...
static char rcsid [] = "$Header: /home/petsun4/ty7777/src/libnpg/RCS/savesxr.c,v 1.10 1996/04/03 18:05:56 ty7777 Exp $";
	...
	SXR_OUTPUT	sxr_output;
{
	...
	fprintf (sxrfp, "%s; %s %d%% %s peak template of %s, slices 1-%d; %d/%2.2d/%d; %s\n", 
		sxr_name, 
		(incorrect_delta_z)? "dimensions;": "",
		sxr_output.threshold, 
