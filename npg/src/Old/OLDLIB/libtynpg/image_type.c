/*$Id: image_type.c,v 1.1 1996/04/03 17:58:26 ty7777 Exp $*/
/*$Log: image_type.c,v $
 * Revision 1.1  1996/04/03  17:58:26  ty7777
 * Initial revision
 *
 * Revision 1.19  1995/12/14  19:55:38  ty7777
 * Updated to use NEWimglist.h and arc.h.
 *
...
#endif
static char rcsid [] = "$Header: /home/petsun4/ty7777/src/libnpg/RCS/image_type.c,v 1.1 1996/04/03 17:58:26 ty7777 Exp $";

/*___________________________________________________________________________________
 *
 *	File Name:	ImageType.c
...
#include <petutil/arc.h>
#include <petutil/matrix7.h>
#include <petutil/ifh.h>
#include <petutil/NEWimglist.h>

PUBLIC int ImageType (image_name, encoded_flag, num_slices)
char		*image_name;
...
short		*num_slices;
{
	...
	static char	*function	= "image_type";
	...
	*encoded_flag	= FALSE;
	...
	/* 
 	 ...
 	 */
	{
		if (isecat (image_name, &scan_type, num_slices) != TRUE)
		{
