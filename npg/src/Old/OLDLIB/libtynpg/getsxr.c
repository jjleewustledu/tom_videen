/*$Id: getsxr.c,v 1.22 1996/04/03 20:03:54 ty7777 Exp $
/*$Log: getsxr.c,v $
 * Revision 1.22  1996/04/03  20:03:54  ty7777
 * Modified to read the incorrect_delta_z data with both 2 or 3 strings
 * before the threshold number.
 *
 * Revision 1.21  1996/04/03  18:12:40  ty7777
 * Modified reading threshold value for incorrect_delta_z.
 *
...
static char rcsid [] = "$Header: /home/petsun4/ty7777/src/libnpg/RCS/getsxr.c,v 1.22 1996/04/03 20:03:54 ty7777 Exp $";
	...
	SXR_OUTPUT	*sxr_output;
{
	...
	if (xray_sxr)
	{
		...
		|| num_scanned == 3)) || !sxr_output->incorrect_dz && num_scanned == 3)
		{
