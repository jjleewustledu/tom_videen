/*$Id: build_shortnames.c,v 1.10 1996/04/03 17:53:27 ty7777 Exp $*/
/*$Log: build_shortnames.c,v $
 * Revision 1.10  1996/04/03  17:53:27  ty7777
 * Save before making any further changes.
 *
 * Revision 1.9  1995/12/14  20:02:56  ty7777
 * Use NEWimglsit.h and MAXTOKEN.
 *
...
static char rcsid []= "$Header: /home/petsun4/ty7777/src/libnpg/RCS/build_shortnames.c,v 1.10 1996/04/03 17:53:27 ty7777 Exp $";
	...
	char			*short_sxrfile;
{
	...
	char	extension [MAXTOKEN];
	char	fsuffix [MAXTOKEN];
	char	string [MAXLINE];
	char	subject [MAXTOKEN];
	float	filter_cutoff;
	int	filter_order;
	int	filter_type;
	int	i;
