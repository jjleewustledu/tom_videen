c $Log: bloodflw.f,v $
c Revision 1.3  1992/11/02  16:24:05  tom
c Eliminate prompt from metproc version copied to this directory
c
...
C
			RCSHEADER = "$Header: /home/petsun2/tom/src/fastproc/src/RCS/bloodflw.f,v 1.3 1992/11/02 16:24:05 tom Exp $"
      SUMX2 = 0.
      SUMX3 = 0.
      SUMX4 = 0.
      SUMX2Y= 0.
