/*$Id: drawxray.c,v 1.2 1994/09/02 21:28:18 ty7777 Exp tom $*/
/*$Log: drawxray.c,v $
...
static char     rcsid[] = "$Id: drawxray.c,v 1.2 1994/09/02 21:28:18 ty7777 Exp tom $";
	...
	GRAPHICS_DATA  *graphics_data;
{
	...
	/*
	 * for (i = 0; i < sxr_output->number_slices; i++) { if (sxr_output->rlslicedim [i - 1] >=
	 * 1.0) { XDrawLine (display, window, gc, drawing_points->slices_ap [2 * i].x +
	 * DISPLAY_MARGIN_WIDTH, drawing_points->slices_ap [2 * i].y + DISPLAY_MARGIN_HEIGHT,
