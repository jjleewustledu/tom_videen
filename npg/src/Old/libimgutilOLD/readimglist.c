/*	$Id: readimglist.c,v 2.1 1999/12/13 17:04:17 tom Exp $
	$Log: readimglist.c,v $
 ...
 */
#ifndef lint
static char		rcsid[] = "$Header: /home/npggw/tom/src/libimgutilOLD/RCS/readimglist.c,v 2.1 1999/12/13 17:04:17 tom Exp $";
#endif 
