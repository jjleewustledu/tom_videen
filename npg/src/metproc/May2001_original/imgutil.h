/*  $Log: imgutil.h,v $
 * Revision 1.19  1999/07/22  19:02:40  tom
 * add voi_mode
 *
 * Revision 1.18  1999/07/15  15:10:23  tom
 * change VOI_SPHERE to VOI_OLD_SPHERE
 * acc VOI_NEW_SPHERE
 *
 * Revision 1.17  1999/07/14  21:12:20  tom
 * add procPET2, procOxygen2
 *
 * Revision 1.16  1999/06/30  16:56:30  tom
 * add PROC_ODIV
 *
 * Revision 1.15  1999/05/07  15:52:20  tom
 * add FILTER_GAUSS2D
 *
 * Revision 1.14  1998/05/27  18:00:17  tom
 * add voi_order
 *
 * Revision 1.13  1998/05/27  15:36:15  tom
 * add procPET, procOxygen
 *
 * Revision 1.12  1997/06/02  20:03:25  tom
 * add voi_zero_chk to PARAMETER_DATA
 *
 * Revision 1.11  1997/03/19  22:23:57  tom
 * *** empty log message ***
 *
 * Revision 1.10  1996/11/06  16:58:24  tom
 * add SCALE factors
 *
 ...
 * Initial revision
 *
    $Id: imgutil.h,v 1.19 1999/07/22 19:02:40 tom Exp tom $
 */
/* =============================================================================
 *  Module:         imgutil.h
 *  Date:           Feb-96
...
#ifndef	lint
static char     imgutil_rcsid[] = "$Header: /usr/local/npg/include/RCS/imgutil.h,v 1.19 1999/07/22 19:02:40 tom Exp tom $";
#endif
...
#define FILTER_GAUSS2D		3		 /* filter is gauss2d */
...
#define	VOI_OLD_SPHERE		2	 	 /* the voi is sphere-shaped (old sphere) */
#define	VOI_CYLINDER		3	 	 /* the voi is cylindrical-shaped */
#define	VOI_NEW_SPHERE		4	 	 /* the voi is sphere-shaped (new, true sphere) */
...
#define	PROC_ODIV 			7		 /* processing: odiv, used in imean */
#define SCALE_OEF			1000.	 /* scaling applied to pixels in OEF images */
#define SCALE_CMRO2			1000.	 /* scaling applied to pixels in CMRO2 images */
#define SCALE_CBV			100.	 /* scaling applied to pixels in CBV images */
#define SCALE_CBF			50.		 /* scaling applied to pixels in CBF images */
...
typedef struct {
	...
	int             voi_order;		 	 /* 0: original; 1: mean counts, then metab proc */
	int             voi_mode;		 	 /* 0: single; 1: paired */
	...
	int         	voi_zero_chk;	 	 /* 1: flag an error for a detected zero (in VOIs) */
...
typedef struct {
	...
	float	pieslope;
	float	efactor;
	float	ho_blood_to_plasma;
	float	oo_blood_to_plasma;
	float	oo_plasma_conc;
	short	unused_2 [20];
