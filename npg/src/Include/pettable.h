 ...
 * Initial revision
 *
	$Id: pettable.h,v 1.3 1996/04/04 14:09:33 tom Exp $
 */
/* ===============================================================================
 *	Module:			pettable.h
 *	Date:			Jan-93
...
#ifndef lint
static char rcsid_pettable [] = "$Header: /usr/local/npg/include/RCS/pettable.h,v 1.3 1996/04/04 14:09:33 tom Exp $";
#endif
