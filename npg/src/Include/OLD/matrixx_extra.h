/*    @(#)matrixx_extra.h	2.1   2/24/92     */

/******************************************************/

/* prevent recursive definition */
#ifndef		matrixx_extra_dot_h_defined
#define		matrixx_extra_dot_h_defined
...
MatrixFile *matrixx_open(), *matrixx_create();
...
MatrixData *matrixx_read(), *matrixx_object_create();
...
#endif		matrixx_extra_dot_h_defined
