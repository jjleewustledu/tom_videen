/*  $Id: image.h,v 1.4 1996/08/02 12:37:44 tom Exp $
 *	$Log: image.h,v $
...
#ifndef	lint
static char     image_rcsid[] = "$Header: /usr/local/npg/include/RCS/image.h,v 1.4 1996/08/02 12:37:44 tom Exp $";
#endif
