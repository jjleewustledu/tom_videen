 ...
 * =============================================================================
 */
static char     rcsid[] = "$Header: /home/npggw/tom/src/libimage/PreVersion/RCS/put_mhif.c,v 1.5 2002/08/20 18:26:49 tom Exp $";
