/*$Id: rtsacs.c,v 1.2 1995/01/30 17:07:48 ty7777 Exp $*/
/*$Log: rtsacs.c,v $
 * Revision 1.2  1995/01/30  17:07:48  ty7777
 * Added program version.
 **/

/* @(#)rtsacs.c	1.1 4/13/91 */

#ifndef	lint
static char sccsid[]="@(#)rtsacs.c	1.1 4/13/91 Copyright 1991 CTI Pet Systems, Inc.";
#endif	lint
...
static char rcsid [] = "$Header: /export/home/npggw/tom/src/recon3d/RCS/rtsacs.c,v 1.2 1995/01/30 17:07:48 ty7777 Exp $";
...
caddr_t buffer;
{
    ...
    bcopy (buffer, wrArgs.wdat.wdat_val, bufferSize);
