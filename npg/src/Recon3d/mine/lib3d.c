/*$Id: lib3d.c,v 1.2 1995/01/30 17:01:22 ty7777 Exp $*/
/*$Log: lib3d.c,v $
 * Revision 1.2  1995/01/30  17:01:22  ty7777
 * Added program version.
 **/

/* @(#)lib3d.c	1.18 12/29/92 */
...
static char sccsid[]="@(#)lib3d.c	1.18 12/29/92 Copyright 1991-92 CTI Pet Systems, Inc.";
static char rcsid [] = "$Header: /export/home/npggw/tom/src/recon3d/RCS/lib3d.c,v 1.2 1995/01/30 17:01:22 ty7777 Exp $";
  ...
  char *file, *matstr;
{
	...
	Mat_dir dir, mat_read_dir();	/* holds file directory */
	short int *b1;
	FILE *fptr;
  ...
  float zoff, theta, phi, size;
{
	...
	*/
	sint	= sin ((double) phi * M_PI / 180.0);
	cost	= cos ((double) phi * M_PI / 180.0);
	...
	*/
	sint	= sin ((double) theta * M_PI / 180.0);
	cost	= cos ((double) theta * M_PI / 180.0);
