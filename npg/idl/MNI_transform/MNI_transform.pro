; $Id: MNI_transform.pro,v 1.4 2008/11/17 21:58:19 tom Exp $
;
;+
; NAME:
;	MNI_TRANSFORM
...
;		4) point in AC-PC plane at brain edge right
...
;	Modification of fiducial_transform by: Tom Videen, Jan 2009.
;
;-
...
PRO MNI_TRANSFORM
	...
	y = a.res.y_dim
	z = a.res.z_dim
	RESMAT = [[x-fidpts[0,0],x-fidpts[1,0],x-fidcalc[0,0],x-fidpts[6,0]], $
			  [y-fidpts[0,1],y-fidpts[1,1],y-fidcalc[0,1],y-fidpts[6,1]], $
			  [z-fidpts[0,2],z-fidpts[1,2],z-fidcalc[0,2],z-fidpts[6,2]], $
			  [1,1,1,1]]
	print,str1
	print,RESMAT
	...
	str = 'MNI_transform from '+fidptsfile+' to '+stdfile
	len = strlen(str)
