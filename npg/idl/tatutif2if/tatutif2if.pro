; $Id: tatutif2if.pro,v 1.2 2005/03/01 21:53:40 tom Exp $
;+
; NAME:
;   TATUTIF2IF
;
...
;   Tom Videen, Dec 2007 (modification of tif2if for Tatu et al 1998 arterial territories)
;-
...
@IMAGE_UTILS.h
   ...
   printf, lu1, 'conversion program := tatutif2if.pro'
   printf, lu1, 'program date       := 2007:12:10'
