...
;	ndeg = degree in X and Y of polynomials to be fitted (max ndeg = 7 or 35 terms)
...
;
; NOTE:
; This routine merely convert the pixel coordinates into a form REGRESS can digest.
;
